                ...
                <div className="flex flex-col items-center justify-center mt-32 lg:mt-16">
                    ...
                    <div className="flex flex-col gap-y-4 md:gap-y-4 items-stretch justify-center">
                        <Ticker className="w-screen" timePeriod={20}>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/1.webp" altText="1"/>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/2.webp" altText="2"/>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/3.webp" altText="3"/>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/4.webp" altText="4"/>
                        </Ticker>
                        <Ticker className="w-screen" timePeriod={20} reverseDirection={true}>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/5.webp" altText="5"/>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/6.webp" altText="6"/>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/7.webp" altText="7"/>
                            <TickerImage className="w-96 h-72" src="/around-the-world-photos/4.webp" altText="4"/>
                        </Ticker>
                    </div>
                </div>
